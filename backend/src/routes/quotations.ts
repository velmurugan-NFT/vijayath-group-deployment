...
router.post('/:id/select-winner', requireAuth, async (req: AuthRequest, res) => {
  ...
  const amount = winner.amount; // demo: ₹18,56,400 for PV Modules full order
